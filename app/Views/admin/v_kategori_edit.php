            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('update-category/'.$post['category_id']) ?>" method="POST" enctype="multipart/form-data" class="forms-sample">
                            <div class="form-group">
                                <label for="exampleInputUsername1">Nama Kategori</label>
                                <input type="text" name="kategori" value="<?php echo $post['category'] ?>" class="form-control"  placeholder="Nama Kategori">
                            </div>
