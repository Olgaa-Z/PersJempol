    ...
    <div class="row">
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          ...
          <form action="<?= base_url('insert-anggota') ?>" method="POST" enctype="multipart/form-data" class="forms-sample">
              <div class="form-group">
                <label for="exampleInputName1">Nama</label>
                <input type="text" name="nama" class="form-control" id="exampleInputName1" placeholder="Nama Anggota">
              </div>
                ...
                <div class="col-md-8">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="radio" class="form-check-input" name="radiojk" id="membershipRadios1" value="Perempuan" checked>
                          Perempuan
                        </label>
                      </div>
                    </div>
                    <div class="col-sm-5">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="radio" class="form-check-input" name="radiojk" id="membershipRadios2" value="Laki-laki">
                          Laki-laki
                        </label>
                      </div>
                    </div>
              ...
              <div class="form-group">
                ...
                <input type="text" name="nohp" class="form-control" id="exampleInputName1" placeholder="No Hp">
              </div>
              <div class="form-group">
                <label for="exampleInputName1">Jurusan</label>
                <input type="text" name="jurusan" class="form-control" id="exampleInputName1" placeholder="Jurusan">
              </div>
