        ...
        <div class="card tale-bg">
          <div class="card-people mt-auto">
            ...
            <div class="weather-info">
              ...
              $temperature_city = $weather_data['name'];

              ?>
              <div class="d-flex">
                <div>
                  <h2 class="mb-0 font-weight-normal"><i class="icon-sun mr-2"></i><?php echo $temperature_in_celcius ?><sup>C</sup></h2>
                </div>
                <div class="ml-2">
                  <h4 class="location font-weight-normal"><?= $temperature_city?></h4>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <ul class="icon-data-list">
              <li>
                <div class="d-flex">
                  <img src="<?= base_url() ?>/assets/template/images/faces/face1.jpg" alt="user">
                  <div>
              ...
              <li>
                <div class="d-flex">
                  <img src="<?= base_url() ?>/assets/template/images/faces/face2.jpg" alt="user">
                  <div>
              ...
              <li>
                <div class="d-flex">
                  <img src="<?= base_url() ?>/assets/template/images/faces/face3.jpg" alt="user">
                  <div>
              ...
              <li>
                <div class="d-flex">
                  <img src="<?= base_url() ?>/assets/template/images/faces/face4.jpg" alt="user">
                  <div>
              ...
              <li>
                <div class="d-flex">
                  <img src="<?= base_url() ?>/assets/template/images/faces/face5.jpg" alt="user">
                  <div>
